...
#connectiing mysql server

mypass = "Punitjadhav07" #use your own password
...
def delete(): 
    ...
    #Submit Button
    SubmitBtn = Button(root,text="SUBMIT",bg='black', fg='white',command=deleteBook)
    SubmitBtn.place(relx=0.28,rely=0.9, relwidth=0.18,relheight=0.08)
